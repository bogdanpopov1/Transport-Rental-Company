...
namespace Company.Classes
{
    internal class Car : Transport
    {
        ...
        public Car(int speed, string colour, string model, string categoryofrights, bool isrented, int numberofwheels, double motor) : base(speed, colour, model, categoryofrights, isrented, numberofwheels, motor)
        {
        }
